...
import { CreateGoiSudung } from '@/service/api';
...
const GoiSuDungAddForm: React.FC<Props> = ({ onSuccess }) => {
    ...
    <>
      ...
      >
        <Form
          hideRequiredMark
          form={form}
          initialValues={{ trangThaiHoatDong: false }}
          layout="vertical"
          onFinish={onFinish}
        >
          <Row gutter={16}>
...
export default GoiSuDungAddForm;
