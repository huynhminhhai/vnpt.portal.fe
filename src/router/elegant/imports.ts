...
"(base)_manage_system-group": () => import("@/pages/(base)/manage/system-group/index.tsx"),
"(base)_manage_system": () => import("@/pages/(base)/manage/system/index.tsx"),
"(base)_manage_tenant": () => import("@/pages/(base)/manage/tenant/index.tsx"),
"(base)_manage_user": () => import("@/pages/(base)/manage/user/index.tsx"),
"(base)_permission_usersystem": () => import("@/pages/(base)/permission/userSystem/index.tsx"),
